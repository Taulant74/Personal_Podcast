        ...
        <div className="col-md-6">
          ...
          <div className="form-check form-switch">
            <input
              ...
              id="publishedSwitch_pub"
            />
            <label className="form-check-label" htmlFor="publishedSwitch_pub" style={{ color: "var(--text)" }}>
        ...
        <div className="col-12">
          <label className="form-label">
            ...
            {requireFile ? (
              ...
              <span style={{ color: "var(--text)", opacity: 0.8 }}>(optional)</span>
            )}
          </label>
          <input
            className="form-control"
