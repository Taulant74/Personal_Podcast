    ...
    <Router>
      ...
      <div className="pp-root">
        ...
        <div className="pp-topbar">
          <div className="container pp-container py-3 d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center gap-4">
              ...
              <Link to="/" className="pp-navlink">Home</Link>
              <Link to="/episodes" className="pp-navlink">Episodes</Link>
            </div>
